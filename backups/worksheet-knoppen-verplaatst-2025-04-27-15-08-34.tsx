...
export default function Worksheet() {
  ...
  const WorksheetFilters = ({
    ...
    return (
      <div className="flex flex-wrap gap-2 items-center mb-4 bg-gray-50 p-3 rounded-md relative z-50"
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Sync Button - rechts van de statistiekknoppen */}
          <Button 
            variant="default" 
            size="sm"
            onClick={async () => {
          ...
          {/* Non-Working Period button - alleen icoon */}
          <Button 
            variant="outline" 
            size="sm"
          ...
          {/* Order Range Button - alleen icoon */}
          <Button 
            variant="outline" 
            size="sm"

...
export default function Worksheet() {
  ...
  const WorksheetFilters = ({
    ...
    return (
      <div className="flex flex-wrap gap-1 items-center mb-0.5 bg-gray-50 p-0.5 rounded-md relative z-50"
        ...
        {/* Clear All Filters Button (kompakte versie) */}
  ...
  return (
    <MainLayout className="pb-0 mb-0">
      ...
      {/* Add WorksheetFilters component above the table with higher z-index */}
      <div className="relative z-[100]"> {/* Wrapper div with higher z-index and relative positioning */}
        <WorksheetFilters

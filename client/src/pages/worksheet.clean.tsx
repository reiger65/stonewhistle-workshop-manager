...
//DISABLED:     // Stap 2.6: Tuning filter toepassen - NIEUWE GESTRUCTUREERDE VERSIE MET UTILS
//DISABLED:     const tuningFilteredOrderIds = new Set<number>();
//DISABLED:     
//DISABLED:     if (tuningFilter !== null) {
//DISABLED:       console.log(`GESTRUCTUREERDE TUNING FILTER: Filteren op tuning "${tuningFilter}"`);
//DISABLED:       
//DISABLED:       // Gebruik de nieuwe filtering utils
//DISABLED:       colorFilteredOrderIds.forEach(orderId => {
//DISABLED:         const orderItems = itemsByOrderForFiltering[orderId];
//DISABLED:         
//DISABLED:         // Check of minstens één item in de order de gevraagde tuning heeft
//DISABLED:         const hasMatchingTuning = orderItems.some(item => {
//DISABLED:           try {
//DISABLED:             // Haal het instrument type op
//DISABLED:             const instrumentType = detectInstrumentType(item);
//DISABLED:             
//DISABLED:             // Haal de tuning van het instrument op via onze gestructureerde functie
//DISABLED:             const itemTuning = getInstrumentTuning(item);
//DISABLED:             
//DISABLED:             // Als er geen tuning gevonden is, geen match
//DISABLED:             if (itemTuning === null) return false;
//DISABLED:             
//DISABLED:             // Gebruik de tuning vergelijkingsfunctie die rekening houdt met instrument-specifieke regels
//DISABLED:             const isMatch = isTuningSimilar(itemTuning, tuningFilter, instrumentType);
//DISABLED:             
//DISABLED:             if (isMatch) {
//DISABLED:               console.log(`✅ MATCH: Item ${item.id} (${item.serialNumber || 'geen SN'}) met tuning ${itemTuning} matcht met filter ${tuningFilter}`);
//DISABLED:               return true;
//DISABLED:             }
//DISABLED:             
//DISABLED:             return false;
//DISABLED:           } catch (error) {
//DISABLED:             console.error('Fout bij tuning filtering:', error);
//DISABLED:             return false;
//DISABLED:           }
//DISABLED:         });
//DISABLED:         
//DISABLED:         if (hasMatchingTuning) {
//DISABLED:           tuningFilteredOrderIds.add(orderId);
//DISABLED:         }
//DISABLED:       });
//DISABLED:     } else {
//DISABLED:       // Als er geen tuning filter is, gebruik alle orders na color filtering
//DISABLED:       colorFilteredOrderIds.forEach(orderId => tuningFilteredOrderIds.add(orderId));
//DISABLED:     }
